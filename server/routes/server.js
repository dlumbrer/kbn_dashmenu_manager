...
export default function (server) {
    ...
    */
    const configElastic = (req) => {
        // Get credentials if the user is logged
        let username, password = ""
        if (req.auth.credentials){
            username = req.auth.credentials._credentials.username;
            password = req.auth.credentials._credentials.password;
        }
